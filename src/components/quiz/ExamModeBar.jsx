// src/components/quiz/ExamModeBar.jsx
    ...
    <div className="mb-3 -mx-4 px-4 py-2 bg-amber-50 dark:bg-amber-900/20 border-y border-amber-200 dark:border-amber-800 text-amber-900 dark:text-amber-100 flex items-center justify-between gap-3">
      {running ? (
        <>
          ...
          <div className="text-sm tabular-nums font-mono" aria-live="polite">
        ...
        <>
          ...
          <div className="flex items-center gap-2">
            <label htmlFor="exam-duration" className="text-xs opacity-70">
              Duration
            </label>
            <select
              id="exam-duration"
