...
const tips = [
  ...
  "Use a 2° to 3° and ½ ball into the operating engine for maximum single engine climb performance. ILS Approach",
  "To catch a localizer without a heading reference, turn toward the needle until it stops moving, then hold wings level.",
  ...
  "A 3° change in pitch will equal a 3° glide path at a given airspeed. ADF Flying",
  "One degree deviation of the ADF needle is equal to 100\" per NM. Compass",
  ...
  "Ata given temperature a .01 increase in mach will result in a 6 knot increase in TAS,",
  "Maximum range TAS will reduce 5% for each 10% reduction in aircraft gross weight 'Aerodynamics",
  ...
  "Each one degree pitch, change will produce a Vertical speed rate of change equal to the mach number X 10 or NM/Min X 100. Ex. 3° pitch change at mach .8: 3X 800 = 2400 fpm. 4, \"Step on the Ball\" to remember which rudder pedal fo push to re-center the slip/skid indicator.",
  ...
  "If the OAT is cooling at arate greater than 5.5 F er 1,000\", the air can be considered unstable. _ fail may be found 10 miles or more from the rain underneath the anvil.",
