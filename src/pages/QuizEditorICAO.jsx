...
export default function QuizEditorICAO() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.id || !formData.question || formData.choices.some(c => !c) || formData.correctIndex === null) {
      alert("Please complete all required fields and select the correct answer.");
      return;
    }
